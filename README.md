# MLA AT3 Group 17 Library

A machine learning project designed to analyse customer behaviour and product dynamics. Built for **36106 Machine Learning Algorithms** — Assignment 3, UTS.
...
## Getting Started
Ensure you have the required packages installed (e.g., `pandas`, `scikit-learn`, `xgboost`, `altair`). Notebooks can be executed seamlessly via Google Colab using the provided `utstd` mounting scripts.
